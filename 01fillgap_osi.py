...
fill_func = fill_med_osi_uv_2
odir = '/files/sea_ice_age/osi405c_demo_archive_filled_v6/'
min_conc = 0.05
n = 3
...
for i, sid_file in enumerate(sid_files):
    ...
    u, v, c, uvf = fill_func(u, v, c, sid_dom_x=sid_dom_x, sic_dom=sic_dom, uvf0=uvf, footprint=footprint, min_conc=min_conc, zf=zf)
